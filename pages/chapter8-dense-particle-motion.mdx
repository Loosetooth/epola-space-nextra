...
epola with the velocity $v_d$ of bulk deformation waves,
...
with the same velocity $v_d = c$, as any epola deformation wave. As any epola
...
> the corpuscular properties of the electromagnetic wave are due to the fact
...
transferred to the particle. Therefore, the uncertainty in the momentum $\Delta M$ of
...
they move in the empty channel and have very little contact with the epola
...
continue as long as the avotons are streaming into the channel, but stops very
