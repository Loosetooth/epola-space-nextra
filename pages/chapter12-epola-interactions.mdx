...
pushing $m_1$ and $m_2$ toward each other.
...
the short-range repulsion, we must conclude that gravitation is not a fundamental
...
insides of the surfaces, there are slightly more epola positrons, and on the
