...
property is that light, which passes deliberately long paths in, e.g., glass or
...
Earth in its motion cannot cause winds in the $10^9$-th times denser epola. The
...
universe and appearing as a background radiation behind the observed spectra
...
reduced, as is the velocity of sound in gases compared to its velocity in solids.
...
frequency occurs also in long-distance long-wave radio-communication on
