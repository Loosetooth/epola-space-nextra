...
We have seen that the substitution of any mass for the mass of the electron is illegal. We are now to show that so is, too, the substitution of the electromagnetic radiation energy by any energy. Hence, in Einstein's $E = mc^2$ formula, the derivation relates to electrons and to the electromagnetic radiation energy caused by them. Any, other understandings should be carefully examined before use.
...
Here, $M$ and $R$ are the mass and radius of the star, in solar units. For the Sun $(M = 1, \ R = 1)$, the redshift, $\Delta\lambda/\lambda = 2.12 \cdot 10^{-6}$ is equivalent to the first-order Doppler shift in the spectrum of a light-source receding with a speed of $600 \ \mathrm{m/s}$.
