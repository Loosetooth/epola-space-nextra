...
Here, the proportionality factor $H$ is the 'Hubble constant', $H = 100 (km/s)/Mpc$, and $l$ is expressed in megaparsecs ($1 Mpc = 3.3\cdot 10^6$ light years, or $2.1 \cdot 10^{11}$ astronomical units, or $3 \cdot 10^{19}$ km).
